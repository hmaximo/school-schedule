...
namespace Domain.Controllers
{
    public class DisciplinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ProfessorId,ClassesPerWeek,SchoolYear,KnowlegdeArea")] Discipline discipline)
        {
            ...
            ViewData["ProfessorId"] = new SelectList(_context.Professor, "Id", "Name", discipline.ProfessorId);
            return View(discipline);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ProfessorId,ClassesPerWeek,SchoolYear,KnowlegdeArea")] Discipline discipline)
        {
            if (id != discipline.Id)
            {
                return NotFound();
